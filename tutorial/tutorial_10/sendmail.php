<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    foreach ($results as $result) {
      $isMailIndb = $isMailIndb || $result['email'] == $email;
    }
    if (!$email) {
    ...
    if (!$errors) {
      ...
      $message = "http://localhost/php_training/tutorials/tutorial_10/reset_password.php?data=$serialData";
      $header = "From:sale@.com\r\n";
